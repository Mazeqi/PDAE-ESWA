...
_BACKBONES = {
    ...
    "vit_small": 'timm.create_model("vit_small_patch16_224", pretrained=False)',
    ...
    "vit_base_patch32_384":'timm.create_model("vit_base_patch32_384", pretrained=True)',
    ...
    "efficientnet_b5": 'timm.create_model("tf_efficientnet_b5", pretrained=False)',
    "efficientnet_b3": 'timm.create_model("tf_efficientnet_b3", pretrained=False)',
    "efficientnet_b1": 'timm.create_model("tf_efficientnet_b1", pretrained=False)',
    "efficientnetv2_m": 'timm.create_model("tf_efficientnetv2_m", pretrained=False)',
    "efficientnetv2_l": 'timm.create_model("tf_efficientnetv2_l", pretrained=False)',
    "efficientnet_b3a": 'timm.create_model("efficientnet_b3a", pretrained=False)',
    "cait_xs24_384": 'timm.create_model("cait_xs24_384", pretrained=True)',
    "cait": 'timm.create_model("cait_xxs24_384", pretrained=True)',
    "cait_s24_384":'timm.create_model("cait_s24_384", pretrained=True)',
    "cait_xxs36_384":'timm.create_model("cait_xxs36_384", pretrained=True)',
}
...
if __name__ == "__main__":
    from util import NetworkFeatureAggregator
    import torch
    backbone_aug = load_backbone("cait_s24_384")
    print(backbone_aug)
    feat_aug_agg = NetworkFeatureAggregator(backbone_aug, ["blocks.5"], "cpu")
    #print(backbone_aug)
    rand_vec = torch.rand([2, 3, 384, 384])
    print(feat_aug_agg(rand_vec)["blocks.5"].shape)
